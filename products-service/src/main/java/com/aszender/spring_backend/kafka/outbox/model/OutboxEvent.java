...
public class OutboxEvent {
    ...
    public static OutboxEvent pending(String aggregateType, Long aggregateId, String eventType,
                                      String topic, String eventKey, String payload) {
    ...
    public void recordFailure(Throwable error) {
        ...
        this.lastError = msg.length() > LAST_ERROR_MAX_LENGTH ? msg.substring(0, LAST_ERROR_MAX_LENGTH) : msg;
    }
