...
public final class InventoryServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "com.aszender.inventory.v1.InventoryService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.aszender.contracts.inventory.v1.ReserveStockRequest,
      com.aszender.contracts.inventory.v1.ReserveStockResponse> getReserveStockMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ReserveStock",
      requestType = com.aszender.contracts.inventory.v1.ReserveStockRequest.class,
      responseType = com.aszender.contracts.inventory.v1.ReserveStockResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.aszender.contracts.inventory.v1.ReserveStockRequest,
      com.aszender.contracts.inventory.v1.ReserveStockResponse> getReserveStockMethod() {
    io.grpc.MethodDescriptor<com.aszender.contracts.inventory.v1.ReserveStockRequest, com.aszender.contracts.inventory.v1.ReserveStockResponse> getReserveStockMethod;
      ...
      synchronized (InventoryServiceGrpc.class) {
        if ((getReserveStockMethod = InventoryServiceGrpc.getReserveStockMethod) == null) {
          InventoryServiceGrpc.getReserveStockMethod = getReserveStockMethod =
              io.grpc.MethodDescriptor.<com.aszender.contracts.inventory.v1.ReserveStockRequest, com.aszender.contracts.inventory.v1.ReserveStockResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ReserveStock"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.aszender.contracts.inventory.v1.ReserveStockRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.aszender.contracts.inventory.v1.ReserveStockResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void reserveStock(com.aszender.contracts.inventory.v1.ReserveStockRequest request,
        io.grpc.stub.StreamObserver<com.aszender.contracts.inventory.v1.ReserveStockResponse> responseObserver) {
  ...
  public static final class InventoryServiceStub
    ...
    /**
     */
    public void reserveStock(com.aszender.contracts.inventory.v1.ReserveStockRequest request,
        io.grpc.stub.StreamObserver<com.aszender.contracts.inventory.v1.ReserveStockResponse> responseObserver) {
  ...
  public static final class InventoryServiceBlockingStub
    ...
    /**
     */
    public com.aszender.contracts.inventory.v1.ReserveStockResponse reserveStock(com.aszender.contracts.inventory.v1.ReserveStockRequest request) {
  ...
  public static final class InventoryServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.aszender.contracts.inventory.v1.ReserveStockResponse> reserveStock(
        com.aszender.contracts.inventory.v1.ReserveStockRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_RESERVE_STOCK:
          serviceImpl.reserveStock((com.aszender.contracts.inventory.v1.ReserveStockRequest) request,
              (io.grpc.stub.StreamObserver<com.aszender.contracts.inventory.v1.ReserveStockResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.aszender.contracts.inventory.v1.ReserveStockRequest,
              com.aszender.contracts.inventory.v1.ReserveStockResponse>(
  ...
  private static abstract class InventoryServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.aszender.contracts.inventory.v1.InventoryProto.getDescriptor();
    }
